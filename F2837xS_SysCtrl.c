...
// This function must reside in RAM
    ...
    InitSysPll(XTAL_OSC,IMULT_40,FMULT_0,PLLCLK_BY_1); 		//PLLSYSCLK = (XTAL_OSC) * (IMULT + FMULT) / (PLLSYSCLKDIV)
#else
    InitSysPll(XTAL_OSC,IMULT_20,FMULT_0,PLLCLK_BY_1); 		//PLLSYSCLK = (XTAL_OSC) * (IMULT + FMULT) / (PLLSYSCLKDIV)
#endif
